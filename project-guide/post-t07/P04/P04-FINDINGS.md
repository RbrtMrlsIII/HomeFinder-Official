...
## Fresh findings
1. T02 Main Hall GLB geometry is source-correspondent, but its target definition currently uses `cameraMode: shared-house-camera` with no source-bound H-03 camera values.
