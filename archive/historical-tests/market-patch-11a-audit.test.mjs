...
const audit = read('docs/patches/PATCH-11A-BACKEND-AUDIT.md');
...
assert.match(sot, /Boost 3 .*\+1 pin/);
assert.match(sot, /Broker HQ is permitted to discover around the broker's current service-pin coordinates/);
assert.match(audit, /11A status: COMPLETE/);
