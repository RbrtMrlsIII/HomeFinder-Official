...
assert.match(sot, /Repair 05 — Subscription entitlement consumption \/ capacity wiring/);
assert.match(sot, /active, in-window subscription yields unlimited listing-attempt capacity/);
