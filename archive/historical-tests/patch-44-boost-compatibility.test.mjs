...
const c8 = registry.surfaces.find((s) => s.id === 'COMP-008');
const c9 = registry.surfaces.find((s) => s.id === 'COMP-009');
assert.equal(c8.status, 'retired');
assert.equal(c9.status, 'retired');
